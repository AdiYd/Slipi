  ...
  return (
    <div style={{gap}} className="relative flex">
      <div 
        ...
        onClick={() => toggleTheme()}
        className="p-3 rounded-full  cursor-pointer bg-white/50 dark:bg-black/50 backdrop-blur-md text-text-light dark:text-text-dark hover:scale-110 transition-transform duration-200 ease-in-out"
      >
